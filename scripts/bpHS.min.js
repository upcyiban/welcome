...
!function (e, t, n) {
  ...
  e.fn.bpHS = function (s) {
    ...
    return this.each(function () {
      ...
      var a = e(this), l = a.find('.bp-hs_inner'), r = l.find('.bp-hs_inner__item'), u = r.length, c = function () {
        l.css({width: r.width() * u})
      };
      c();
      var o = function () {
        c()
      ...
      var b = [i(s.prevText, 'button', 'bp-btn bp-hs_control__prev'), i(s.nextText, 'button', 'bp-btn bp-hs_control__next')], p = n.createDocumentFragment();
      if (s.showButtons)for (var _ = 0; _ < b.length; _++)p.appendChild(b[_]);
      if (u > 1) {
        if (s.showBullets)for (a.find('.bp-hs_control').append('<div class="bp-bullets">'), _ = 0; u > _; _++)a.find('.bp-bullets').append('<i class="bp-bullets_bullet">');
